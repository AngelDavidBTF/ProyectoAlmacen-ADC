...
p:hover {
  text-shadow: 2px 2px 20px  #2c90c6, #fff 0 -1px 2px;
    ...
    <body>
        ...
        ?>
        <div class="Registro">
            <p class="texto">Codigo Caja a Borrar:</p><br>
        <form action="../CONTROLADOR/controlSalidaCajas.php" method="POST">
            <input type="text" name="CodigoCaja" placeholder="Codigo Caja a Borrar"><br><br>
