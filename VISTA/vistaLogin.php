...
p:hover {
  text-shadow: 2px 2px 20px  #2c90c6, #fff 0 -1px 2px;
    ...
    <form method="post" action="../CONTROLADOR/ControladorLogIn.php">
        <span class="fontawesome-user"></span><input type="text" required placeholder="Nombre de usuario" autocomplete="off" name="nombre"> 
        <span class="fontawesome-lock"></span><input type="password" id="password" required placeholder="Contraseña" autocomplete="off" name="contraseña"> 
        <input type="submit" value="Enviar" title="Enviar" name="enviar">
        <br>
        <br>
        <input type="submit" value="Registrar" title="Enviar" name="enviar">
    </body>
</html>
